                ...
                <div className="añadir-gastos">
                    <div className="añadir-categorias">
                        <div className="añadir-servicios">
                            ...
                            <img src={serv ? remove : add} alt="" className='imgAdd-serv' onClick={handlerServ}/>
                        </div>
                        {serv == true && <Valores/>}
                    </div>
                    <div className="añadir-categorias">
                        <div className="añadir-sinCategoria">
                            ...
                            <img src={sc ? remove : add} alt="" className='imgAdd-sc' onClick={handlerSc}/>
                        </div>
                        {sc == true && <Valores/>}
                    </div>
                    <div className="añadir-categorias">
                        <div className="añadir-supermercado">
                            ...
                            <img src={sup ? remove : add} alt="" className='imgAdd-super' onClick={handlerSup}/>
                        </div>
                        {sup == true && <Valores/>}
                    </div>
                    <div className="añadir-categorias">
                        <div className="añadir-restaurantes">
                            ...
                            <img src={rb ? remove : add} alt="" className='imgAdd-rest' onClick={handlerRb}/>
                        </div>
                        {rb == true && <Valores/>}
                    </div>
                </div>
